...
class NovaServiceProvider extends NovaApplicationServiceProvider
{
    ...
    public function boot()
    {
        ...
        Nova::footer(function ($request) {
            return '<p class="text-center"><b>Powered by <a class="link-default" href="https://healingchamber.exponentialhealthcare.com"/>https://healingchamber.exponentialhealthcare.com</a> © '. date('Y') .'</b> </p>';
        });
